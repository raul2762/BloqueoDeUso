   ...
   public static class InputBox
    {
        ...
        private static PictureBox Picture(Icon icon)
        {
            ...
            {
                case Icon.Error:
                    stream = assembly.GetManifestResourceStream(@"UseLockForms.error.png");
                    break;
                case Icon.Exclamation:
                    stream = assembly.GetManifestResourceStream(@"UseLockForms.exclamation.png");
                    break;
                case Icon.Information:
                    stream = assembly.GetManifestResourceStream(@"UseLockForms.information.png");
                    break;
                case Icon.Question:
                    stream = assembly.GetManifestResourceStream(@"UseLockForms.question.png");
                    break;
                case Icon.Nothing:
                    stream = assembly.GetManifestResourceStream(@"UseLockForms.nic80x80.png");
                    break;
            }
